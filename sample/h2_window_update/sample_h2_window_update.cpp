...
int main() {
  ...
  const mh2c::window_update_frame connection_wuf{0u, 1024u};
  h2_client.send_frame(connection_wuf);

  const mh2c::window_update_frame stream_wuf{stream_id, 1024u};
  h2_client.send_frame(stream_wuf);
